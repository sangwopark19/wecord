...
- [x] 게시글/댓글 신고 — Validated in Phase 6
- [x] 관리자 대시보드 (커뮤니티/크리에이터/멤버 관리, 모더레이션, 공지, 배너, 분석) — Validated in Phase 6
- [x] 더보기 탭 (글로벌 프로필 편집, 앱 설정, 로그아웃) — Validated in Phase 7
- [x] Shop 탭 (인앱 WebView → x-square.kr) — Validated in Phase 7
- [x] DM 탭 플레이스홀더 ("곧 출시" + 알림받기) — Validated in Phase 7

### Active

(MVP 스코프 완료 — App Store/Play Store 제출은 `.planning/phases/07-launch-polish/07-03-MANUAL-FOLLOWUP.md` §1-9 수동 단계로 진행)
...
---
*Last updated: 2026-04-22 after Phase 7 completion (MVP code+docs complete; manual cutover deferred to 07-03-MANUAL-FOLLOWUP.md)*
