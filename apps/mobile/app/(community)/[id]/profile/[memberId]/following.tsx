...
import { useFollowingList } from '../../../../../hooks/community/useFollowingList';
import { type FollowMember } from '../../../../../hooks/community/useFollowerList';
...
export default function FollowingListScreen() {
  ...
  const { data: following, isLoading } = useFollowingList(memberId ?? '');
